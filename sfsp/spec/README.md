...
| SFSP-160 | `SFSP-160-SELF-SOVEREIGN-IDENTITY.md` | **Nueva (25-sep).** Identidad autosoberana, la capa Web5 de SFSP: `did:key` por relación para personas, `did:web` para emisores, credenciales W3C con divulgación selectiva por Merkle, listas de estado, presentaciones con audiencia y reto, proyección en `SFSPIdentityAdapter` sin cambiar contratos, permisos y datos cifrados de la persona | `draft-0.4`, nueva, con código y pruebas | **D22**, D13, D06 |
