...
const S = {
  es: {
    ...
    'rem.resRate': 'Tasa de referencia',
    'rem.disclaimer': 'Tasas de referencia con fines informativos. El monto exacto en moneda local depende del cambio del día cuando el destinatario venda a fiat.',
  ...
  en: {
    ...
    'rem.resRate': 'Reference rate',
    'rem.disclaimer': 'Reference rates for information only. The exact local-currency amount depends on the day’s FX when the recipient sells to fiat.',
