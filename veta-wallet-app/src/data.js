...
export const TOKEN_META = {
  ...
  AUKA: { s: 'AUKA', n: 'Auka · Oro', glyph: 'Au', grad: ['#F8EFCF', '#C9A961', '#96793F'], fg: '#3A2C08' },
  AGKA: { s: 'AGKA', n: 'Agka · Plata', glyph: 'Ag', grad: ['#EDF1F3', '#B4BCC2', '#7C858C'], fg: '#2A2F33' },
  ONDK: { s: 'ONDK', n: 'ONDK', glyph: '◈', grad: ['#1E8C74', '#0A463F'], fg: '#EAD79C' },
  MNKA: { s: 'MNKA', n: 'Monarka', glyph: '♛', grad: ['#F8EFCF', '#C9A961', '#96793F'], fg: '#3A2C08' },
};
