  ...
  if (company === null) {
    return (
      <SafeAreaView style={styles.center}>
        ...
        <Pressable onPress={() => router.replace('/registrar-empresa')} style={{ marginTop: 16 }}>
          <GradientButton label="Registrar mi empresa" onPress={() => router.replace('/registrar-empresa')} />
        </Pressable>
      </SafeAreaView>
    )
  }
