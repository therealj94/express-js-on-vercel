...
import { ArrowRight, Compass, Eye, EyeOff, Lock, Mail, User, X } from 'lucide-react-native'
...
export default function Signup() {
  ...
  async function onSubmit() {
    ...
    try {
      ...
      router.replace(isBusiness ? '/registrar-empresa' : '/(tabs)/panel')
    } catch {
        ...
        <ScrollView bounces={false} keyboardShouldPersistTaps="handled">
          <View style={styles.hero}>
            ...
            <View style={styles.heroText}>
              <Text style={styles.heroTitle}>Del rendimiento en ORIGEN al gasto cotidiano</Text>
            </View>
          </View>

          <View style={styles.form}>
            <Text style={styles.title}>{isBusiness ? 'Afilia tu negocio' : 'Crea tu cuenta'}</Text>
