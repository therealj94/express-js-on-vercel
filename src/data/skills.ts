...
export const skillsData: SkillsData = {
  ...
  video: {
    ...
    resources: [
      ...
      {
        name: 'Higgsfield AI',
        description: 'AI creative suite for generating video from text or reference images, with an MCP server that connects it directly to Claude',
  ...
  images: {
    ...
    resources: [
      ...
      {
        name: 'Higgsfield AI',
        description: 'AI creative suite for generating images from text or reference images, with an MCP server that connects it directly to Claude',
        url: 'https://higgsfield.ai',
        level: 'beginner',
        pricing: 'freemium',
        type: 'tool',
