  ...
  "l-licencias": [
    {
      ...
      parrafos: [
        ...
        "El primero es la licencia FinTech de Sistema Alternativo de Transacciones, Clase B, que se reenfoca hacia la red de pagos y la conversión de ORIGEN a moneda fiduciaria para la Freedom Card (el intercambio en cadena se integró en Ordenex, de Au Corp.).",
      ...
      datos: [
        ...
        ["Trámite 1", "FinTech ATS Clase B — red de pagos de Orden Global — § 3-2-190"],
  ...
  "l-sociedad": [
    {
      ...
      parrafos: [
        ...
        "De esta sociedad dependen la cadena de bloques, el cripto ORIGEN y todas las plataformas: Veta Wallet, Genesis ID, MyTokenPay, Ordenscan, AuPad, LaunchPad y las tarjetas.",
