...
es: {
  ...
  'nav.fiat': 'Fiat', 'nav.comprar': 'Comprar', 'nav.vender': 'Vender', 'nav.convertir': 'Convertir', 'nav.actividad': 'Actividad',
  'nav.salir': 'Salir',
...
en: {
  ...
  'nav.fiat': 'Fiat', 'nav.comprar': 'Buy', 'nav.vender': 'Sell', 'nav.convertir': 'Convert', 'nav.actividad': 'Activity',
  'nav.salir': 'Sign out',
