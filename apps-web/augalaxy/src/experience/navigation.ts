...
export const useExperience=create<ExperienceState>((set)=>({stage:'gate',selected:null,windowId:null,settings:false,directory:false,help:false,ready:false,unsupported:false,fps:60,hovered:null,tutorial:false,journey:null,rendererChoice:null,rendererActual:'lite',webglAvailable:null,set}));
