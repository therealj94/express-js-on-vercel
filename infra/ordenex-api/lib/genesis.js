...
//
// Ordenex es una app del ecosistema como la wallet o MyTokenPay: habla con
// Genesis con SU propia clave de API (X-API-Key, GENESIS_API_KEY — el alta de
// la app `ordenex` en APPS_ECOSISTEMA), y esa clave vive SOLO en este
...
// verificar el SSO con el que entra la gente, tamizar la direccion de cada
