...
//
// Pero Ordenex NO vive de ese pase. El pase se usa UNA vez, en /auth/sso, y a
...
// memoria, cada llamada de cada persona sería una llamada a Genesis: Ordenex
// dejaría de funcionar cada vez que Genesis tosa, y Genesis recibiría el
// tráfico de Ordenex entero. Con un minuto de memoria, el peor caso es que
...
//
//   Fail-closed en cada petición = Genesis se cae y Ordenex se cae con él,
...
const MEMORIA_MS = Number(process.env.ORDENEX_BLOQUEO_MEMORIA_MS || 60_000);
/** Cuánto se aguanta sin respuesta fresca antes de dejar de operar. */
const VENTANA_CIEGA_MS = Number(process.env.ORDENEX_BLOQUEO_CIEGO_MS || 900_000);
