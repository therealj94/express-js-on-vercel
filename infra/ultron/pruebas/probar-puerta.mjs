...
titulo('los instrumentos, a mano: el mismo camino que usa ULTRON');
{
  ...
  const ESCRIBEN_ESPERADAS = 'anotar_pendiente,aprender,boveda_aplicar,cerrar_pendiente,crear_documento,desplegarse,equipo_correr,habilidad_crear,habilidad_publicar,heroku_reiniciar,nodo_comando,olvidar,proponer_envio,recordar,repo_proponer_cambio,salud_reparar,terminal';
