...
| **ULTRON OS** | El sistema operativo del ecosistema. Dos modos, se eligen en Ajustes y se guardan con el correo: **Chat** (hilo tipo Grok, con historial; tablero/bóveda/ajustes a un botón) y **Consola** (el OS de siempre: núcleo, paneles y muelle). El resto de Ajustes no cambia. | `public/os.html`, `public/js/os.js`, `public/js/trabajo.js` |
