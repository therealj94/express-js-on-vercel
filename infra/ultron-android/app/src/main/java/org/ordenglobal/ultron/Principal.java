...
public class Principal extends AppCompatActivity {
    ...
    private String abrirCon(Intent i) {
        ...
        if (d != null && BuildConfig.CASA.contains(String.valueOf(d.getHost()))) return d.toString();
    ...
    private void prepararWeb() {
        ...
        web.setWebViewClient(new WebViewClient() {
            ...
            @Override public boolean shouldOverrideUrlLoading(WebView v, WebResourceRequest r) {
                Uri u = r.getUrl();
                String h = String.valueOf(u.getHost());
                if (BuildConfig.CASA.contains(h)) return false;
