...
// AUCORP_TOKEN — el secreto es de esta casa, no el PASS_TOKEN de la wallet:
...
async function sesion(req, res, next) {
  ...
  if (!secreto) {
    ...
    console.error('[sesion] AUCORP_TOKEN no esta puesto: no se puede verificar ninguna sesion');
