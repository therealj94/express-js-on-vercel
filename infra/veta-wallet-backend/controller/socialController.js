  ...
  try {
    ...
    if (user) {
      ...
      user = new User({
        email: correo,
        user: correo,
        // El username va con el CORREO, igual que en `registerUserWallet`, y no
        // con el nombre de Google. En Mongo sobrevive un indice unico
        // `username_1` de un esquema anterior; con el nombre, dos personas que
        // se llamen igual chocarian y la segunda no podria entrar nunca. El
        // correo ya es unico, asi que nunca choca.
        username: correo,
        name: identidad.nombre || undefined,
