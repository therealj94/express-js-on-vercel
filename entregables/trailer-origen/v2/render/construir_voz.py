...
SR = 48000
subprocess.run([FFMPEG, '-loglevel', 'error', '-y', '-i', str(AQUI / 'voz-damian-tomaA.mp3'), '-ac', '1', '-ar', str(SR), '/tmp/voz-toma.wav'], check=True)
...
INTRO = 2.2
PAUSAS = [INTRO, .7, .9, 1.3, .8, 1.0, .8, 1.2, 1.0, 1.1, .6, 1.5, .9]
COLA = 4.0
