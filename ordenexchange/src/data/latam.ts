...
export const PAISES: Pais[] = [
  {
    ...
    metodos: [
      ...
      billetera('cuenta-dni', 'Cuenta DNI', 'Cuenta DNI', [campo('cbu', 'CBU de Cuenta DNI', 'Cuenta DNI CBU', true, '0140999801234567890123'), alias('nombre.apellido.cdni')]),
      billetera('modo', 'MODO', 'MODO', [telefono('+54 9 11 1234 5678'), campo('cbu', 'CBU o CVU', 'CBU or CVU', false, '0110599520000012345678'), alias('nombre.apellido')]),
      ...
      billetera('personal-pay', 'Personal Pay', 'Personal Pay', [cvu(true, 'CVU de Personal Pay', 'Personal Pay CVU'), alias('nombre.ppay')]),
      billetera('prex', 'Prex', 'Prex', [cvu(true, 'CVU de Prex', 'Prex CVU'), alias('nombre.prex')]),
  ...
  },
  {
    ...
    metodos: [
      ...
      porTelefono('bille', 'Bille', '+591 6 987 6543'),
      porTelefono('yasta', 'Yasta', '+591 7 234 5678'),
  ...
  },
  {
    ...
    metodos: [
      ...
      billetera('mercado-pago', 'Mercado Pago', 'Mercado Pago', [campo('llave', 'Llave Pix de Mercado Pago', 'Mercado Pago Pix key', true, '+55 11 91234-5678'), campo('cpf', 'CPF del titular', 'Holder CPF', false, '123.456.789-00')]),
      billetera('picpay', 'PicPay', 'PicPay', [campo('llave', 'Llave Pix de PicPay', 'PicPay Pix key', true, '123.456.789-00'), alias('@nombre.apellido')]),
      billetera('pagbank', 'PagBank', 'PagBank', [campo('llave', 'Llave Pix de PagBank', 'PagBank Pix key', true, '123.456.789-00'), campo('cpf', 'CPF del titular', 'Holder CPF', false, '123.456.789-00')]),
      efectivo('São Paulo'),
    ],
  },
  {
    ...
    metodos: [
      ...
      billetera('mercado-pago', 'Mercado Pago', 'Mercado Pago', [cuenta('12345678', 'Número de Cuenta Vista', 'Cuenta Vista number'), campo('rut', 'RUT del titular', 'Holder RUT', true, '12.345.678-9'), campo('contacto', 'Correo de la cuenta', 'Account email', false, 'nombre@correo.cl')]),
      efectivo('Santiago'),
    ],
  },
  {
  ...
  },
  {
    ...
    metodos: [
      ...
      zelle(),
      porTelefono('tpago', 'tPago', '+1 809 555 1234'),
  ...
  },
  {
    ...
    metodos: [
      ...
      porTelefono('peigo', 'Peigo', '+593 99 123 4567'),
      efectivo('Quito'),
    ],
  },
  {
  ...
  },
  {
    ...
    metodos: [
      ...
      porTelefono('ueno', 'Billetera ueno', '+595 981 123 456'),
      efectivo('Asunción'),
    ],
  },
  {
