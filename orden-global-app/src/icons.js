...
const PATHS = {
  ...
  /* La llamada. Mismo trazo y misma rejilla 24×24 que el resto: un icono
  ...
  'mic-off': ['M12 3.2a2.6 2.6 0 0 1 2.6 2.6v5.4a2.6 2.6 0 0 1-5.2 0V5.8A2.6 2.6 0 0 1 12 3.2z', 'M5.8 11.2a6.2 6.2 0 0 0 12.4 0', 'M12 17.4V21', 'M3 3l18 18'],
  'videocam-off': ['M2.5 7.5A1.5 1.5 0 0 1 4 6h9a1.5 1.5 0 0 1 1.5 1.5v9A1.5 1.5 0 0 1 13 18H4a1.5 1.5 0 0 1-1.5-1.5z', 'M14.5 10.2l7-3.7v11l-7-3.7', 'M3 3l18 18'],
  'camera-reverse': ['M4 8.4h3.2l1.4-2h6.8l1.4 2H20a1.6 1.6 0 0 1 1.6 1.6v8A1.6 1.6 0 0 1 20 19.6H4A1.6 1.6 0 0 1 2.4 18v-8A1.6 1.6 0 0 1 4 8.4z', 'M9.6 13.6a2.6 2.6 0 0 0 4.6 1.6', 'M14.4 13.6a2.6 2.6 0 0 0-4.6-1.6', 'M9.6 11.4v2.2h2.2', 'M14.4 15.8v-2.2h-2.2'],
