...
// El catálogo (RUBROS, PAISES con sus ciudades, DIAS) vive ahora en
// ./catalogo.js — UNA sola vez. Antes había dos catálogos con el mismo
// nombre y forma distinta (este PAISES de 18 con ciudades vs el objeto de 6
// de comerciosDemo; 15 RUBROS vs 13 CATS con slugs que el directorio no
// conocía) y el mismo comercio podía decir cosas distintas según la
// pantalla. Se re-exportan tal cual porque el panel del negocio y la ficha
// pública ya los leen de aquí: nadie más tuvo que cambiar.
import { RUBROS, PAISES, DIAS } from './catalogo';
export { RUBROS, PAISES, DIAS };
