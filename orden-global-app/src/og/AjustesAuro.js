// Los ajustes de PULSE2CHAT: lo mío y lo que de mí ve el resto.
...
const TXT = {
  es: {
    titulo: 'PULSE2CHAT', sub: 'Mi perfil y lo que se ve de mí',
    perfilTit: 'MI PERFIL',
    nombrePh: 'Tu nombre',
    ...
    gidTxt: 'Quien lo tenga te encuentra en PULSE2CHAT buscándolo tal cual.',
    ...
    gidInvito: 'Búscame en PULSE2CHAT con mi Genesis ID:',
    ...
    invito: 'Escríbeme por PULSE2CHAT:',
    ...
    veTxt: 'Quien te busque en PULSE2CHAT ve tu nombre, tu foto, tu correo, tu Genesis ID y tu dirección de wallet — nada más: ni tu teléfono, ni tus documentos, ni con quién hablas.',
  ...
  en: {
    titulo: 'PULSE2CHAT', sub: 'My profile and what others see',
    ...
    gidTxt: 'Anyone who has it can find you on PULSE2CHAT by searching it as is.',
    gidCopiar: 'COPY GID',
    ...
    gidInvito: 'Find me on PULSE2CHAT with my Genesis ID:',
    ...
    invito: 'Write to me on PULSE2CHAT:',
    ...
    veTxt: 'Anyone searching for you on PULSE2CHAT sees your name, your photo, your email, your Genesis ID and your wallet address — nothing else: not your phone, not your documents, not who you talk to.',
