// Los grupos de PULSE2CHAT. Tres caras del mismo grupo en una sola pantalla,
...
const TXT = {
  es: {
    ...
    invito: 'Te invito al grupo «{g}» en PULSE2CHAT.',
    invitarTit: 'INVITAR POR CORREO', correoPh: 'correo@ejemplo.com', invitar: 'INVITAR',
    invitado: 'Ya está dentro del grupo.',
    noEsta: 'Ese correo no está en PULSE2CHAT todavía, o ya es del grupo. Mándale el enlace.',
  ...
  en: {
    ...
    invito: 'I invite you to the group “{g}” on PULSE2CHAT.',
    invitarTit: 'INVITE BY EMAIL', correoPh: 'name@example.com', invitar: 'INVITE',
    invitado: 'They are in the group now.',
    noEsta: 'That email is not on PULSE2CHAT yet, or is already in the group. Send them the link.',
...
// PULSE2CHAT y tres copias acaban pintando a la misma persona distinto. La
